...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_NOTIFY_MULTIPLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_NOTIFY_MULTIPLE_FLUSH_MS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_HFXO_CAP_INT_VALUE_X2, 14);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NORDIC_QSPI_NOR_ACTIVE_DWELL_MS, 10);
