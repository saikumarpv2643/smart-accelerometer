...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x13479, (ISR)0x20a91}, /* 42 */
	{(const void *)0x13e71, (ISR)0x20a91}, /* 43 */
