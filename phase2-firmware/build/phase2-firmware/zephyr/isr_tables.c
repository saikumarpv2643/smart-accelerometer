...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x132b5, (ISR)0x208cd}, /* 42 */
	{(const void *)0x13cad, (ISR)0x208cd}, /* 43 */
