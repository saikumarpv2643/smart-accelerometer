...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0xd9d1, (ISR)0x1bd11}, /* 42 */
	{(const void *)0xe3c9, (ISR)0x1bd11}, /* 43 */
