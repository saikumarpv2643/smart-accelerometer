...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x134e5, (ISR)0x20b4f}, /* 42 */
	{(const void *)0x13edd, (ISR)0x20b4f}, /* 43 */
